package com.icommerce.app.shopping.user.service.config;
...
import com.icommerce.app.shopping.common.authentication.impl.TokenGeneratorImpl;
...
import com.icommerce.app.shopping.user.service.util.NullSerializer;
...
@Configuration
@RefreshScope
@EnableFeignClients(basePackages = "com.icommerce.app.shopping.user.service")
public class AppConfiguration {
    ...
    public TokenGenerator tokenGenerator() throws IOException {
        return new TokenGeneratorImpl(jwtKey);
    }
