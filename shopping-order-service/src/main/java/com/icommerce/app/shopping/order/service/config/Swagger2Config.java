...
public class Swagger2Config {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.icommerce.app.shopping.order.service.rest.controller"))
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("Shopping Order Service API")
                .description("Shopping Order Service API")
                .version("0.0.1")
                .build();
    }
